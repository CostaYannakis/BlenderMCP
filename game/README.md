...
public/balmoral.glb    371 meshes, ~107k triangles, 2K textures
public/level.json      lamp positions, room markers, door/window openings
...
materials as textures (above); and writes `public/balmoral.glb` plus
`public/level.json`.
